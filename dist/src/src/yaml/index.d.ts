...
export declare function dump(data: any, replacer?: Replacer, options?: YAML.DumpOptions): string;
export declare function dumpFile(path: string, data: any, replacer?: Replacer, options?: YAML.DumpOptions): void;
